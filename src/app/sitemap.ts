...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  return [
    ...
    { url: `${baseUrl}/chinh-sach-thanh-toan`, changeFrequency: "monthly", priority: 0.6 },
    { url: `${baseUrl}/chinh-sach-van-chuyen`, changeFrequency: "monthly", priority: 0.6 },
    { url: `${baseUrl}/chinh-sach-bao-hanh`, changeFrequency: "monthly", priority: 0.6 },
    { url: `${baseUrl}/chinh-sach-doi-tra`, changeFrequency: "monthly", priority: 0.6 },
    ...categoryUrls,
    ...productUrls,
    ...articleUrls,
  ];
