    ...
    <footer className="bg-[var(--color-bg-muted)] text-[var(--color-text-muted)] mt-12">
      <Container>
        ...
        <div className="py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10">
          {/* Giới thiệu */}
          <div>
            <h4 className="text-[var(--color-text-default)] font-semibold mb-3">
              Nội Thất
            </h4>
            <p className="text-sm leading-6">
              Chúng tôi mang đến những sản phẩm nội thất chất lượng, thiết kế
              tinh tế và hiện đại, giúp không gian sống của bạn trở nên ấm cúng
              và tiện nghi hơn.
            </p>
          </div>
        ...
        <div className="border-t border-[var(--color-brand-50)] py-6 text-center text-sm text-[var(--color-text-muted)]">
          ...
          <span className="text-[var(--color-brand-300)] font-medium">
            Sofa Ecommerce Team
          </span>
          .
        </div>
